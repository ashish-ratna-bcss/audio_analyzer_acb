...
def select(*, indic_text, indic_source, indic_agreement, indic_abstained,
    ...
    """Return the winning ASR record.

    Keys: text, source ("whisper"|"indic_enhanced"|"indic_original"|...),
    confidence, agreement (None when not embedding-compared), reason
    (selection rationale), flag (review-flag reason or None).
    """
    ...
    # Engines disagree on pure-native text -> keep Whisper but flag for review.
